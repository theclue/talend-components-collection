...
public class TalendRowTweetBehaviour extends Observable implements TalendFlowBehaviour, Observer {
	...
	private TwitterLogicalOperator twitterLogicalOperator;
	 ...
	 */
	public TalendRowTweetBehaviour(TwitterStream client, String entitiesSeparator, boolean includeHash,
			TwitterLogicalOperator twitterLogicalOperator) {
	...
	public TwitterLogicalOperator getTwitterLogicalOperator() {
		return twitterLogicalOperator;
	}

	public void setTwitterLogicalOperator(TwitterLogicalOperator twitterLogicalOperator) {
		this.twitterLogicalOperator = twitterLogicalOperator;
	}
	...
	private boolean filter(Status status) {
		...
		if (this.twitterLogicalOperator == TwitterLogicalOperator.AND) {
