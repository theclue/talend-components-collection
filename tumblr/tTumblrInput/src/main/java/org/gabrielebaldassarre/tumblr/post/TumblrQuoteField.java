...
public class TumblrQuoteField extends TumblrPostField {
	
	public static final TalendType SOURCE = TalendType.STRING;
	public static final TalendType TEXT = TalendType.INTEGER;
}
