...
public class TumblrTextField extends TumblrPostField {
	
	public static final TalendType TITLE = TalendType.STRING;
	public static final TalendType BODY = TalendType.STRING;
